"""
Legacy BPM detector wrapper.

Routes tempo detection through the unified analyzer to keep one maintained
implementation instead of a prototype script with hardcoded audio devices.
"""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Detect BPM with Sonic AI.")
...
def main() -> int:
    ...
    print(f"Detected Tempo: {results.get('tempo', 'Unknown')} BPM")
    print(f"Confidence: {results.get('tempo_confidence', 0):.1%}")
